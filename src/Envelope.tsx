...
import { useAppdSelector } from "./appStore.ts";
import { getRegisterTotal, moneyToString } from "./registerUtils";
...
export const Envelope = () => {
  const coinBox = useAppdSelector((state) => state.registerState.coinBox);
  const noteBox = useAppdSelector((state) => state.registerState.noteBox);
  const previousCoinBox = useAppdSelector(
    (state) => state.registerState.previous?.coinBox
  );
  const previousNoteBox = useAppdSelector(
