...
import note50 from "./assets/note50.png";
import note100 from "./assets/note100.png";
import { useAppDispatch, useAppdSelector } from "./appStore.ts";
import { moneyToString } from "./registerUtils.ts";
